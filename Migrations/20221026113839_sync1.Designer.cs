...
namespace Traveler.Migrations
{
    ...
    [Migration("20221026113839_sync1")]
    partial class sync1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Traveler.Models.Tipos.TipoTelefono", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Traveler.Models.Turista.Contacto.TuristaCorreo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TuristasCorreos");
                });

            modelBuilder.Entity("Traveler.Models.Turista.Contacto.TuristaTelefono", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TuristasTelefonos");
                });

            modelBuilder.Entity("Traveler.Models.Turista.Contacto.TuristaUbicacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Traveler.Models.Turista.Contacto.TuristaTelefono", b =>
                {
                    b.HasOne("Traveler.Models.Tipos.TipoTelefono", "TipoTelefono")
                        .WithMany()
            ...
            modelBuilder.Entity("Traveler.Models.Turista.Turista", b =>
                {
                    ...
                    b.HasOne("Traveler.Models.Turista.Contacto.TuristaUbicacion", "Destino")
                        .WithMany()
                        .HasForeignKey("DestinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Traveler.Models.Tipos.MotivoViaje", "MotivoViaje")
                        .WithMany()
                        .HasForeignKey("MotivoViajeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Traveler.Models.Turista.Contacto.TuristaUbicacion", "Origen")
                        .WithMany()
